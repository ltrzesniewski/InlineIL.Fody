...
namespace InlineIL
{
    ...
    public enum NoArg : byte
    {
        ...
        /// <see cref="InvalidCastException"/> can optionally still be thrown if the check would fail.
        ...
        /// <see cref="IndexOutOfRangeException"/> can optionally still be thrown if the check would fail.
        ...
        /// <see cref="NullReferenceException"/> can optionally still be thrown if the check would fail.
